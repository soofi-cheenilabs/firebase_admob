...
public class FirebaseAdMobPlugin implements MethodCallHandler {
  ...
  private void callSetCustomData(MethodCall call, Result result) {
    String customData = call.argument("customData");
    System.out.println("\n\ncustomData from call set custom data: " + customData);
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    switch (call.method) {
      ...
      case "loadInterstitialAd":
        ...
        break;
      case "setCustomData":
        System.out.println("from switch case block setCustomData");
        callSetCustomData(call, result);
        break;
      case "getCustomData":
        System.out.println("\n\nget custom data in switch case");
        // callGetCustomData(call, result);
        break;
      case "setUserId":
        System.out.println("in java, switch case");
