...
class RewardedVideoAd {
  ...
  Future<bool> setUserId(
    ...
    print('\n\nfrom admob.dart, user id: $userId');
    return _invokeBooleanMethod("setUserId", <String, dynamic>{
      'userId': userId,
    });
  }

  Future<bool> setCustomData({@required String customData}) {
    assert(customData.isNotEmpty);
    print("\n\ncustomData from admob.dart: $customData");
    return _invokeBooleanMethod("setCustomData", <String, dynamic>{
